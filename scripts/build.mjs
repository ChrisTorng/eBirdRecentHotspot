...
await buildSummaries(source);
await mkdir(target, { recursive: true });
for (const file of ['index.html', 'index.css', 'app.js', 'model.js', 'heat.js', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png']) await cp(file, resolve(target, file));
