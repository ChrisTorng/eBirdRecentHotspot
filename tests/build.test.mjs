...
test('build includes all snapshots and only public assets', async () => {
  ...
  try {
    for (const path of ['index.html', 'index.css', 'app.js', 'model.js', 'manifest.webmanifest', 'icon-192.png', 'icon-512.png', 'scripts', 'examples']) {
    ...
    assert.deepEqual((await readdir(join(temp, '_site'))).sort(), ['app.js', 'data', 'icon-192.png', 'icon-512.png', 'index.css', 'index.html', 'manifest.webmanifest', 'model.js']);
